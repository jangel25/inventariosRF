...
{
    public class FicSrvNavigationCatProductos : IFicSrvNavigationCatProductos
    {
        private IDictionary<Type, Type> viewModelRouting = new Dictionary<Type, Type>()
        {

            { typeof(FicVmConteoCatProductosList), typeof(FicViCpConteoCatProductosList)},
            { typeof(FicVmConteoCatProductosItem), typeof(FicViCpConteoCatProductosItem)},
            { typeof(FicVmConteoCatProductosDetalle), typeof(FicViCpConteoCatProductosDetalle)}
        };
